...
import { errorLogger, errorResponder, requestLogger } from './middlewares/ErrorHandler';
...
app.all("*", (req: Request, res: Response, next: NextFunction) => {
  next(new AppError({ httpCode: HttpCode.BAD_REQUEST, description: `Request no to ${req.originalUrl} not found` }))
});
